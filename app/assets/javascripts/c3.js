(function (window) {
    ...
    c3_chart_internal_fn.isOrderDescPounds = function () {
        var config = this.config;
        return typeof(config.data_order) === 'string' && config.data_order.toLowerCase() === 'desc_pounds';
    };
    ...
    c3_chart_internal_fn.getTooltipContent = function (d, defaultTitleFormat, defaultValueFormat, color) {
        var $$ = this, config = $$.config,
            ...
            orderAsc = $$.isOrderAsc(),
            orderDescPounds = $$.isOrderDescPounds();
        ...
        var length = orderDescPounds ? 10 : d.length;
        var extra_customers_count = 0

        for (i = 0; i < d.length; i++) {

            if (! (d[i] && (d[i].value || d[i].value === 0))) { continue; }

            if (orderDescPounds && i >= length) {
                extra_customers_count++;
                continue;
            }
        ...
        if (orderDescPounds) {
            text += "<tr class='" + $$.CLASS.tooltipName + "-" + 1000 + "'>";
            text += "<td class='name'>" + extra_customers_count + " more customers...</td>";
            text += "</tr>";
        }
        return text + "</table>";
    };
